...
Setiap modul tersedia dalam Bahasa Inggris dan Indonesia di path yang identik (`en/…` ↔ `id/…`). Daftar lengkap 16 kategori dan 103 sub-bidang ada pada bagian English di atas (klik "16 categories · 103 sub-fields"), dan peta lengkapnya di [`id/docs/taxonomy.md`](id/docs/taxonomy.md).
