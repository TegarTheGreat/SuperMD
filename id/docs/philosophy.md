...
3. **Core universal, domain hasil komposisi.** Aturan yang berlaku di semua bidang tinggal di satu tempat. Modul domain hanya menambahkan apa yang tidak mungkin diketahui core: audiens, artefak, standar, kosakata, dan klise khas bidang itu. Karena itulah sekumpulan kategori ringkas plus satu adapter mencakup long tail profesi — mesin anti-slop tidak pernah perlu diulang.
